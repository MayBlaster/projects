...
var vec__29931 = cljs.core.rest(expr);
var seq__29932 = cljs.core.seq(vec__29931);
var first__29933 = cljs.core.first(seq__29932);
var seq__29932__$1 = cljs.core.next(seq__29932);
var vec__29934 = first__29933;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29934,(0),null);
var form = seq__29932__$1;
...
var G__29937 = x;
var G__29937__$1 = (((G__29937 == null))?null:spec_tools.impl.polish(G__29937));
var G__29937__$2 = (((G__29937__$1 == null))?null:cljs.core.name(G__29937__$1));
if((G__29937__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__29937__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__29938 = x;
var G__29938__$1 = (((G__29938 == null))?null:cljs.core.name(G__29938));
if((G__29938__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__29938__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__29939){
...
var data = map__29940__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29940__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29940__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29940__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29940__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__29943){
...
var data = map__29944__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29944__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29944__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__29946 = data;
var G__29946__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__29946,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__29946);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__29946__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__29946__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__29950 = form;
var G__29950__$1 = (((G__29950 == null))?null:cljs.core.rest(G__29950));
if((G__29950__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__29950__$1);
}
})();
var G__29951 = m;
var G__29951__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__29951,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__29947_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__29947_SHARP_)));
})):G__29951);
var G__29951__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__29951__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__29948_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__29948_SHARP_)));
})):G__29951__$1);
var G__29951__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__29951__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__29949_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__29949_SHARP_));
})):G__29951__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__29951__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__29952 = (function (){var G__29953 = form;
var G__29953__$1 = (((G__29953 == null))?null:cljs.core.rest(G__29953));
if((G__29953__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__29953__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29952__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29952__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29952__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29952__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__29959 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__29959) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__29960 = form;
var G__29960__$1 = (((G__29960 == null))?null:cljs.core.seq(G__29960));
var G__29960__$2 = (((G__29960__$1 == null))?null:cljs.core.first(G__29960__$1));
if((G__29960__$2 == null)){
return null;
} else {
var fexpr__29961 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__29961.cljs$core$IFn$_invoke$arity$1 ? fexpr__29961.cljs$core$IFn$_invoke$arity$1(G__29960__$2) : fexpr__29961.call(null,G__29960__$2));
}
})():null));
});
/**
...
var len__4736__auto___29981 = arguments.length;
var i__4737__auto___29982 = (0);
while(true){
if((i__4737__auto___29982 < len__4736__auto___29981)){
args__4742__auto__.push((arguments[i__4737__auto___29982]));

var G__29983 = (i__4737__auto___29982 + (1));
i__4737__auto___29982 = G__29983;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq29962){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29962));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__29963){
var vec__29964 = p__29963;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29964,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29964,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__29969){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29970__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29970__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29970__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29970__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__29967_SHARP_){
return cljs.core.map_QMARK_(p1__29967_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__29968_SHARP_){
return cljs.core.contains_QMARK_(p1__29968_SHARP_,x);
});
}),req_keys));
