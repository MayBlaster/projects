...
if((i < len)){
var k = (ks[i]);
var G__26562 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__26563 = (i + (1));
m = G__26562;
i = G__26563;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26477 = c;
var G__26477__$1 = (((G__26477 == null))?null:G__26477.prototype);
if((G__26477__$1 == null)){
return null;
} else {
return G__26477__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26482 = c;
var G__26482__$1 = (((G__26482 == null))?null:G__26482.prototype);
if((G__26482__$1 == null)){
return null;
} else {
return G__26482__$1.render;
}
})() == null)))));
});
...
var G__26487 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26487) : reagent.impl.component.as_element.call(null,G__26487));
};
...
while (G__26566__i < G__26566__a.length) {G__26566__a[G__26566__i] = arguments[G__26566__i + 0]; ++G__26566__i;}
  args = new cljs.core.IndexedSeq(G__26566__a,0,null);
} 
...
var G__26488 = c;
var G__26488__$1 = (((G__26488 == null))?null:G__26488.constructor);
if((G__26488__$1 == null)){
return null;
} else {
return G__26488__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__26490 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26491 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26491);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26490);
}});
...
var c = this;
var G__26541_26570 = goog.object.get(c,"cljsRatom");
if((G__26541_26570 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26541_26570);
}
...
var renders_26571 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26572 = cljs.core.first(cljs.core.vals(renders_26571));
...
if((cljs.core.count(renders_26571) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26571))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26572)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26572], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26558 = o;
goog.object.set(G__26558,cljs.core.name(k),v);
