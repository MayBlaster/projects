...
var G__26573 = o;
goog.object.set(G__26573,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26598__i < G__26598__a.length) {G__26598__a[G__26598__i] = arguments[G__26598__i + 0]; ++G__26598__i;}
  args = new cljs.core.IndexedSeq(G__26598__a,0,null);
} 
return G__26597__delegate.call(this,args);};
G__26597.cljs$lang$maxFixedArity = 0;
G__26597.cljs$lang$applyTo = (function (arglist__26601){
...
var G__26574 = o;
goog.object.set(G__26574,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__26575 = props;
var G__26575__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26575,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26575);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26575__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__26575__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26576 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26576,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26576;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26577){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26578__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__26580_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26580_SHARP_);
}));
} else {
return null;
}
...
var vec__26582 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26582,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26582,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26582,(2),null);
...
var temp__5739__auto___26659 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___26659 == null)){
} else {
var key_26660 = temp__5739__auto___26659;
(jsprops.key = key_26660);
}
...
var temp__5739__auto___26663 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___26663 == null)){
} else {
var key_26664 = temp__5739__auto___26663;
(jsprops.key = key_26664);
}
...
var G__26586 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26586) : reagent.impl.template.as_element.call(null,G__26586));
} else {
var temp__5739__auto___26665 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___26665 == null)){
} else {
var key_26666 = temp__5739__auto___26665;
(jsprops.key = key_26666);
}
...
var G__26588 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__26588)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__26588)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26589){
...
break;
default:
var G__26676 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26676;
continue;
...
var ctx = ({});
var vec__26593 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26593,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26593,(1),null);
...
var G__26596 = (cljs.core.count(argv) - first_child);
switch (G__26596) {
case (0):
