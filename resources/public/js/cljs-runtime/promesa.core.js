...
try{var G__28191_28280 = (function (p1__28184_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28184_SHARP_);
});
var G__28192_28281 = (function (p1__28185_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28185_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28191_28280,G__28192_28281) : f.call(null,G__28191_28280,G__28192_28281));
}catch (e28190){var e_28282 = e28190;
promesa.protocols._reject_BANG_(d,e_28282);
}
return d;
}));
...
try{var G__28194 = (function (p1__28186_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28186_SHARP_);
});
var G__28195 = (function (p1__28187_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28187_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28194,G__28195) : f.call(null,G__28194,G__28195));
}catch (e28193){var e = e28193;
...
var len__4736__auto___28289 = arguments.length;
var i__4737__auto___28290 = (0);
while(true){
if((i__4737__auto___28290 < len__4736__auto___28289)){
args_arr__4757__auto__.push((arguments[i__4737__auto___28290]));

var G__28291 = (i__4737__auto___28290 + (1));
i__4737__auto___28290 = G__28291;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28206_SHARP_,p2__28207_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28206_SHARP_,p2__28207_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq28209){
...
args_arr__4757__auto__.push((arguments[i__4737__auto___28294]));
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq28214){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28215,G__28216,seq28214__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28222_SHARP_){
return (p1__28222_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28225_SHARP_){
return (p1__28225_SHARP_ instanceof pred_or_type);
}));
...
var seq__28232 = cljs.core.seq(promises);
var chunk__28233 = null;
var count__28234 = (0);
var i__28235 = (0);
while(true){
if((i__28235 < count__28234)){
var p = chunk__28233.cljs$core$IIndexed$_nth$arity$2(null,i__28235);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28232,chunk__28233,count__28234,i__28235,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28232,chunk__28233,count__28234,i__28235,p,state){
...
});})(seq__28232,chunk__28233,count__28234,i__28235,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28232,chunk__28233,count__28234,i__28235,p,state))
),((function (seq__28232,chunk__28233,count__28234,i__28235,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28232,chunk__28233,count__28234,i__28235,p,state){
return (function (state__$1){
...
var map__28242 = cljs.core.deref(state);
var map__28242__$1 = (((((!((map__28242 == null))))?(((((map__28242.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28242.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28242):map__28242);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28242__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28242__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28242__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__28244 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28244) : reject.call(null,G__28244));
} else {
...
var G__28302 = seq__28232;
var G__28303 = chunk__28233;
var G__28304 = count__28234;
var G__28305 = (i__28235 + (1));
seq__28232 = G__28302;
chunk__28233 = G__28303;
count__28234 = G__28304;
i__28235 = G__28305;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28232);
if(temp__5735__auto__){
var seq__28232__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28232__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28232__$1);
var G__28306 = cljs.core.chunk_rest(seq__28232__$1);
var G__28307 = c__4556__auto__;
var G__28308 = cljs.core.count(c__4556__auto__);
var G__28309 = (0);
seq__28232 = G__28306;
chunk__28233 = G__28307;
count__28234 = G__28308;
i__28235 = G__28309;
continue;
} else {
var p = cljs.core.first(seq__28232__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state))
),((function (seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28232,chunk__28233,count__28234,i__28235,p,seq__28232__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__28245 = cljs.core.deref(state);
...
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28245__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28245__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28245__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__28247 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28247) : reject.call(null,G__28247));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__28310 = cljs.core.next(seq__28232__$1);
var G__28311 = null;
var G__28312 = (0);
var G__28313 = (0);
seq__28232 = G__28310;
chunk__28233 = G__28311;
count__28234 = G__28312;
i__28235 = G__28313;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28248_SHARP_,p2__28249_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28248_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__28249_SHARP_) : f.call(null,p2__28249_SHARP_));
}));
...
return (function() { 
var G__28316__delegate = function (args){
return promesa.core.create.cljs$core$IFn$_invoke$arity$1((function (resolve,reject){
...
}catch (e28254){if((e28254 instanceof Error)){
var e = e28254;
...
while (G__28317__i < G__28317__a.length) {G__28317__a[G__28317__i] = arguments[G__28317__i + 0]; ++G__28317__i;}
  args = new cljs.core.IndexedSeq(G__28317__a,0,null);
} 
return G__28316__delegate.call(this,args);};
G__28316.cljs$lang$maxFixedArity = 0;
G__28316.cljs$lang$applyTo = (function (arglist__28318){
var args = cljs.core.seq(arglist__28318);
return G__28316__delegate(args);
});
