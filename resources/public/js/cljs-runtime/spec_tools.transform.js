...
if((x instanceof cljs.core.Keyword)){
var G__30093 = spec;
var G__30094 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__30095 = spec;
var G__30096 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30095,G__30096) : f.call(null,G__30095,G__30096));
} else {
return x;
...
if(typeof x === 'number'){
var G__30118 = spec;
var G__30119 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30118,G__30119) : f.call(null,G__30118,G__30119));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e30121){if((e30121 instanceof Error)){
var ___$1 = e30121;
return x;
} else {
throw e30121;
...
}catch (e30145){if((e30145 instanceof Error)){
var ___$1 = e30145;
return x;
} else {
throw e30145;
...
}catch (e30154){if((e30154 instanceof Error)){
var ___$1 = e30154;
return x;
} else {
throw e30154;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__30155,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30156__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__30160,x){
var map__30161 = p__30160;
var map__30161__$1 = (((((!((map__30161 == null))))?(((((map__30161.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30161.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30161):map__30161);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30161__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__30188,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30191__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
