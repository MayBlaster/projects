...
var clojure$core$rrb_vector$protocols$PSpliceableVector$_splicev$dyn_31616 = (function (v1,v2){
...
return clojure$core$rrb_vector$protocols$PSpliceableVector$_splicev$dyn_31616(v1,v2);
}
});
...
var clojure$core$rrb_vector$protocols$PSliceableVector$_slicev$dyn_31617 = (function (v,start,end){
...
if((!((m__4429__auto__ == null)))){
return (m__4429__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4429__auto__.cljs$core$IFn$_invoke$arity$3(v,start,end) : m__4429__auto__.call(null,v,start,end));
} else {
var m__4426__auto__ = (clojure.core.rrb_vector.protocols._slicev["_"]);
if((!((m__4426__auto__ == null)))){
return (m__4426__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4426__auto__.cljs$core$IFn$_invoke$arity$3(v,start,end) : m__4426__auto__.call(null,v,start,end));
} else {
...
return clojure$core$rrb_vector$protocols$PSliceableVector$_slicev$dyn_31617(v,start,end);
}
});
